document.addEventListener("DOMContentLoaded", function() {
    ...
    function switchLanguage() {
        if (currentLanguage === 'en') {
            document.getElementById("language-flag").src = "https://www.drapeauxdespays.fr/data/flags/emoji/twitter/256x256/fr.png";
            document.getElementById("current-language").textContent = "French";
            currentLanguage = 'fr';
        } else {
            document.getElementById("language-flag").src = "https://images.emojiterra.com/twitter/v13.1/512px/1f1ec-1f1e7.png";
